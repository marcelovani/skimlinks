  ...
  public function blockAccess(AccountInterface $account) {
	...
	public function blockForm($form, FormStateInterface $form_state) {
      ...
      '#title' => t('Badge')
		...
		// Enable the badge
		$form['badge']['skimlinks_enable_badge'] = array(
			'#type' => 'checkbox',
...
Note: please make sure you have accepted T&Cs first to implement... <a href=":link" target="_blank">click here</a>.', array(':link' => 'https://hub.skimlinks.com/toolbox/referral')),
